...
$testimonies=$db->getSomeEmails();
$OurServicesMenuItems= $db->getServicesMenu();
$OurCoursesMenuItems= $db->getCoursesMenu();
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="owl-service-item owl-carousel">
                <?php foreach ($OurServicesMenuItems as $OurServicesMenuItem) { ?>
                    <div class="item">
                        <div class="service-item">
                            <div class="icon">
                                <img src="<?php echo $OurServicesMenuItem['icon']; ?>" alt="">
                            </div>
                            <h4><?php echo $OurServicesMenuItem['display_name']; ?></h4>
                            <p><?php echo $OurServicesMenuItem['content']; ?></p>
                        </div>
                    </div>
                <?php } ?>
          </div>
        ...
        <div class="col-lg-12">
          <div class="owl-testimonials owl-carousel" style="position: relative; z-index: 5;">
              <?php foreach ($testimonies as $testimonie) { ?>
                  <div class="item">
                      <p>“<?php echo $testimonie['message']; ?>”</p>
                      <h4><?php echo $testimonie['name']; ?></h4>
                      <span><?php echo $testimonie['created_at']; ?></span>
  ...
  <section class="contact-us" id="contact-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4">
          <form id="contact" action="addEmailIndex.php" method="post">
            <div class="row">
              <div class="col-lg-12">
                <div class="section-heading">
                  <h6>Contact us</h6>
              ...
              <div class="col-lg-12" >
                <fieldset>
                  <input type="name" name="full_name" id="full_name" placeholder="Full Name" autocomplete="on" required>
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
                  <input type="text" name="mail" id="mail" pattern="[^ @]*@[^ @]*" placeholder="Your Email" required="">
                </fieldset>
              </div>
              <div class="col-lg-12">
                <fieldset>
              ...
              <div class="col-lg-12">
                <fieldset>
                  <button type="submit" name="submit" id="submit" class="main-gradient-button">Send Message</button>
                </fieldset>
              </div>
            </div>
          </form>
